// --------------------------------------------------------------------------
//
// Copyright (c) Ferra srl. All rights reserved.
//
// Module:
//
//     rapiferra.h
...
#define CSIDL_PROGRAM_FILES       0x0026   //Program Groups Folder
...
BOOL CopyFileToCE(CHAR *lpSource,CHAR *lpDest,BOOL fWindowView,void* (*procNotify)(SINT,LONG,void *));
void CopyFolderToCE(CHAR *lpFileSearch,WCHAR *wsFolderDest);

typedef struct {

	CEOSVERSIONINFO sVersionInfo;
